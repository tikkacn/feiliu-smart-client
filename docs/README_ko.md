...
설치 방법, 트러블슈팅, 자주 묻는 질문은 [Feiliu 클라이언트 가이드](https://guide.tikka.cn)를 참고하세요.

### 텔레그램 채널

튜토리얼, 다운로드 및 사용 안내는 [Feiliu 클라이언트 가이드](https://guide.tikka.cn)에서 확인하세요.
...
플랫폼별 가이드는 [Feiliu 클라이언트 가이드](https://guide.tikka.cn)에서 확인하세요.

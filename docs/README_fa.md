...
برای مراحل نصب، عیب‌یابی و سوالات متداول، [راهنمای کلاینت Feiliu](https://guide.tikka.cn) را مطالعه کنید.

### کانال تلگرام

آموزش‌ها، دانلودها و راهنمای استفاده در [راهنمای کلاینت Feiliu](https://guide.tikka.cn) قرار دارد.
...
برای راهنمایی‌های مربوط به هر پلتفرم، به [راهنمای کلاینت Feiliu](https://guide.tikka.cn) مراجعه کنید.

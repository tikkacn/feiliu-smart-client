...
詳しい導入手順やトラブルシュートは [Feiliu クライアントガイド](https://guide.tikka.cn) を参照してください。

### Telegram チャンネル

チュートリアル、ダウンロード、利用方法は [Feiliu クライアントガイド](https://guide.tikka.cn) を参照してください。
...
プラットフォーム別の案内は [Feiliu クライアントガイド](https://guide.tikka.cn) を参照してください。
